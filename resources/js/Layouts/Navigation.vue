    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <div class="flex items-center justify-center  border-slate-200 px-4 py-6 dark:border-slate-700">
            <div class="flex items-center gap-3">
                <div class="flex h-11 w-11 items-center justify-center rounded-xl bg-indigo-100 text-indigo-600 dark:bg-indigo-500/15 dark:text-indigo-300">
                ...
                <div>
                    <p class="text-sm font-semibold tracking-[0.25em] text-slate-500 dark:text-slate-400">RADIUS</p>
                    <p class="text-base font-bold text-slate-900 dark:text-white">FENIX TELECOM</p>
                </div>
            </div>
        </div>
