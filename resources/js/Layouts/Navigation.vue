...
<template>
    ...
    <div :class="$page.props.showingMobileMenu ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
        ...
        <nav class="mt-10" x-data="{ isMultiLevelMenuOpen: false }">
            ...
            <nav-link :href="route('nas.index')" :active="route().current('nas.index')">
                <template #icon>
            ...
            <nav-link :href="route('radcheck.index')" :active="route().current('radcheck.index')">
                <template #icon>
            ...
            <nav-link :href="route('rgroup.index')" :active="route().current('rgroup.index')">
                <template #icon>
            ...
            <nav-link :href="route('radacct.index')" :active="route().current('radacct.index')">
                <template #icon>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round"
