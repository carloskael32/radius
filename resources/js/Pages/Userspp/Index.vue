            ...
            <div class="w-full overflow-hidden">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 text-sm text-left text-gray-600">
                        <thead class="bg-gray-100 text-xs font-medium text-black uppercase tracking-wider">
                            <tr>
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            <tr v-for="r, i in radchecks" :key="r.id" class="text-gray-700 hover:bg-gray-50 transition">
                                ...
                                <td class="px-4 py-3 text-sm border-b border-gray-500">
                                    <span class="text-xs font-medium text-gray-600">Online/Offline</span>
                                </td>
